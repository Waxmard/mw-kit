...
| `gitlab-pipeline-dedup` | baseline | workflow:rules dedup for GitLab — exactly one pipeline per change (branch- or MR-preferred) | `.gitlab-ci.yml` | `.gitlab-ci.yml` | `gitlab` | [universal/gitlab-pipeline-dedup.md](universal/gitlab-pipeline-dedup.md) |
